...
public class CircularProgressButton extends Button {
	...
	private void initAttributes(Context context, AttributeSet attributeSet) {
		...
		try {
			...
			mProgressText = attr
					.getString(R.styleable.CircularProgressButton_cpb_textProgress);
			...
			int idleStateSelector = attr.getResourceId(
					R.styleable.CircularProgressButton_cpb_selectorIdle,
					R.drawable.cpb_idle_state_selector);
			mIdleColorState = getResources().getColorStateList(
					idleStateSelector);

			int completeStateSelector = attr.getResourceId(
					R.styleable.CircularProgressButton_cpb_selectorComplete,
			...
			int errorStateSelector = attr.getResourceId(
					R.styleable.CircularProgressButton_cpb_selectorError,
