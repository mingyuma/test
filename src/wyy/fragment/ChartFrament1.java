...
public class ChartFrament1 extends Fragment implements
	...
	private static final int[] VORDIPLOM_COLORS = { Color.rgb(192, 255, 140),
	...
	private void setData(int count, float range) {
		...
		BarDataSet set1 = new BarDataSet(yVals1, "人数");
